...
unit_donationUnits_8 = DonationUnits 8 `shouldBeHtml` "0.8¢"
unit_donationUnits_32 = DonationUnits 32 `shouldBeHtml` "3.2¢"
unit_donationUnits_100 = DonationUnits 100 `shouldBeHtml` "10.0¢"
unit_donationUnits_101 = DonationUnits 101 `shouldBeHtml` "10.1¢"
unit_donationUnits_1030 = DonationUnits 1030 `shouldBeHtml` "$1.030"
unit_donationUnits_123456 = DonationUnits 123456 `shouldBeHtml` "$123.456"
