...
-- | select an image for purposes of selecting a project logo or user
-- | avatar.
-- | FUTURE WORK: At this point, there is no way to filter, as the
-- | Image table & image uploader page need to be enhanced first.  Once
-- | done, this widget will need to be updated to allow for filtering
-- | & sorting.
